...
(function($) {
    $.fn.pekeUpload = function(options) {
        ...
        var defaults = {
            ...
            errorOnResponse: "上传文件有错",
            onSubmit: true,
            url: "" + ServerIp + "/StudentManage/BatchAddStudent",
            data: null,
            limit: 0,
            limitError: "你已经达到能上传的最大数量!",
            delfiletext: "移除文件",
            onFileError: function(file, error) {alert("上传失败!");},
        ...
        var pekeUpload = {
            ...
            previewFile: function(container, file) {
                ...
                switch (type) {
                  ...
                  //   break;
                    case "xlsx":var fileUrl = window.URL.createObjectURL(file);
                      var prev = $('<img class="thumbnail" src="' + fileUrl + '" height="64" />').appendTo(container);
                      break;
                  default:
            ...
            handleFormSubmission: function() {
                ...
                form.submit(function() {
                    options.data = {'cl_id':cl_id = $("#className").find("option:selected").attr('cl_id')}
